/**
 *Resturant Food Order Menu Bill(Cashier) System
 *Developer Name:- Md.Halim
 *YouTube Channel:- Dewaara (Dewaara Inc.)
 *Date:- 26/02/2020 01:30:15 AM
 */
import java.awt.*;
...
class Login extends JFrame implements KeyListener {
    ...
    public void launchFrame() {
        ...
        loginFrame.setLocation(((screenSize.width - frameSize.width) / 2),((screenSize.height) / 2));
...
class Menu extends JFrame implements KeyListener {
    ...
    private JLabel menuStoreLabel, menuTitleLabel, menuCashierLabel, menuHeaderLabel, menuDateLabel, menuChoiceLabel[], menuGuideLabel;
    ...
    public Menu() {
        ...
        menuStoreLabel = new JLabel(" MD.HALIM RESTAURANT CHATRA");
        ...
        menuTitleLabel.setFont(new Font("Courir New",Font.BOLD,24));
        ...
        // Extra 2 element for Quit and SubTotal option
        ...
        for (int i = 0; i < choice.length; i++) {
            ...
            menuChoiceLabel[choice.length+1] = new JLabel(" [Q] " + option[1] + " " + Login.cashierName);
    ...
    public void launchFrame() {
        ...
        menuCenterPanel.add(menuTitleLabel, BorderLayout.NORTH);
        ...
        menuFrame.pack();
                         ...
                         // Centering the screen on tne desktop
                         Dimension 
                screenSize = Toolkit.getDefaultToolkit().getScreenSize();
                         Dimension
                frameSize = menuFrame.getSize();
                menuFrame.setLocation(((screenSize.width - frameSize.width) / 2) , ((screenSize.height - frameSize.height) / 2));
                ...
                public void keyPressed(KeyEvent e) {
                    switch(e.getKeyCode()) {
                        ...
                        case 81:
                            // Quit program
                            menuFrame.setVisible(false);
                            JOptionPane.showMessageDialog(this, "User Log Off",    "Goodbye and have a nice day!", JOptionPane.INFORMATION_MESSAGE);
    ...
    */
    class SubTotal extends JFrame implements KeyListener {
        ...
        private JLabel subTotalStoreLabel, subTotalTitleLabel, subTotalCashierLabel, subTotalHeaderLabel, subTotalDateLabel, subTotalOrderedLabel[], subTotalGrandTotalLabel, subTotalGuideLabel;
        ...
        public SubTotal() {
            ...
            subTotalStoreLabel = new JLabel(" MD.HALIM RESTAURANT CHATRA ");
            ...
            //Acquire current cashier loged in 
            ...
            subTotalDateLabel = new JLabel(" Date/Time : " + dateFormat.format(calendar.getTime()) + " ");
            subTotalDateLabel.setForeground(Color.red);
            subTotalDateLabel.setFont(new Font("Verdana",Font.BOLD,14));
            
            //Header
            subTotalHeaderLabel = new JLabel("  Food Item"      +"      Price/Unit"     +"      Ordered"        +"      Total(Rs.)   ");
            ...
            for (int i = 0; i < Menu.choice.length; i++)
            {
                if(Menu.ordered[i] > 0) {
                    ...
                    Menu.ordered[i] = 0;
                            ...
                            subTotalGrandTotalLabel.setFont(new Font("Couier New",Font.BOLD,30));
                            subTotalOrderedPanel.add(subTotalGrandTotalLabel);
                            
                            // Simple instructions added for user cashier
                            subTotalGuideLabel = new JLabel("   Prees [ Esc ] to retrun to menu");
                   ...
                   public void launchFrame() {
                        ...
                        subTotalFrame.pack();
                                    ...
                                    subTotalFrame.setLocation(((screenSize.width - frameSize.width) / 2),        ((screenSize.height - frameSize.height) / 2));
